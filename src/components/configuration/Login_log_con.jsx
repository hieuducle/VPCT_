...
export default class Login_log_con extends Component {
    render() {
        return (
            <div>
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-2">
                                <h5>Nhật ký đăng nhập</h5>
                            </div>
                            <div className="col-sm-4">
                                <td className="project-actions text-right">
                                    <a className="btn btn-danger btn-sm mr-2" href="#">
                                    <i class="fas fa-times"></i> Làm sạch
                                    </a>
                            ...
                            <ol className="breadcrumb float-sm-right">
                                <li className="breadcrumb-item"><a href="/system/login_log">Nhật ký</a></li>
